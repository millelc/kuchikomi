...
use obdo\pChartBundle\pBarcode39;
use obdo\pChartBundle\pBarcode128;
...
class ExamplesController extends Controller
{
  ...
  {
      return $this->render('obdopChartBundle:Examples:index.html.twig');
  }
  ...
  public function viewAction($number)
  {
    ...
    return $this->render('obdopChartBundle:Examples:view.html.twig', array('number' => $number, "title" => $title));
  }
