...
class KomiData extends AbstractFixture implements ContainerAwareInterface, OrderedFixtureInterface
{
	...
	public function load(ObjectManager $manager)
	{
		...
		$manager->flush();	
                ...
                $this->createKomi($manager, $AclManager, "P_PostKuchiKomiAction_1", Komi::OS_TYPE_ANDROID, "2.0.0", "okuebfjaokidlmoejan");
                $this->createKomi($manager, $AclManager, "P_PostKuchiKomiAction_1_Abonne", Komi::OS_TYPE_ANDROID, "2.0.0", "okuebfjaokidlmoejan");
                $this->createKomi($manager, $AclManager, "P_DeleteKuchiKomiAction_1", Komi::OS_TYPE_ANDROID, "2.0.0", "okuebfjaokidlmoejan");
