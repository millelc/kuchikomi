...
class KuchiKomiUpdateType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('deletePhoto', 'checkbox', array('required' => false, 'label' => 'Supprimer la photo'))
        ;
    ...
    {
        return 'obdo_kuchikomirestbundle_kuchikomi_update';
    }
}
