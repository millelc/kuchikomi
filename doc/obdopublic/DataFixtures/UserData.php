...
class UserData extends AbstractFixture implements ContainerAwareInterface, OrderedFixtureInterface
{
	...
	public function load(ObjectManager $manager)
	{
		...
		// super admin
                $this->createUser($manager, 'root', 'root', 'root@citykomi.com', array('ROLE_SUPER_ADMIN'), false, true, true);
...
//		$manager->persist($kuchiAdmin);
        ...
        private function createUser($manager,$name,$password,$mail,$roles,$locked=false,$enabled=true, $superAdmin=false)
        {
            $user = new User ();
